...
namespace gameInstance
{
    public class State
    {
        ...
        public Dictionary<int,Card> playerOneCards;
        public Dictionary<int,Card> playerTwoCards;
        ...
        private State()
        {
            ...
            Dictionary<int,Card> playerOneCards = new Dictionary<int,Card>();
            Dictionary<int,Card> playerTwoCards = new Dictionary<int,Card>();
